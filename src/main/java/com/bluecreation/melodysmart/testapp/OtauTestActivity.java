...
public class OtauTestActivity extends BleActivity implements ImageManagerListener, OtauListener {
    ...
    static public final String EXTRAS_IS_RECOVER_OTA = "com.bluecreation.melodysmart.testapp.isRecoverOta";
    static public final String EXTRAS_DEVICE_DATA = "com.bluecreation.melodysmart.testapp.deviceData";
